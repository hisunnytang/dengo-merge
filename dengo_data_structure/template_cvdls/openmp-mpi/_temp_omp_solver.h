...
_temp_omp_data *_temp_omp_setup_data(int *, char***);
...
void _temp_omp_interpolate_gamma(_temp_omp_data*, int );
...
int calculate_jacobian__temp_omp( realtype t,
