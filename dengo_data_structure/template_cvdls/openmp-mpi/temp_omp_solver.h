...
temp_omp_data *temp_omp_setup_data(int *, char***);
...
void temp_omp_interpolate_gamma(temp_omp_data*, int );
...
int calculate_jacobian_temp_omp( realtype t,
