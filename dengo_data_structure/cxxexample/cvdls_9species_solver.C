...
//    }
    ...
    double *H2I = (double *) alloca(dims * sizeof(double));
    double *H2II = (double *) alloca(dims * sizeof(double));
    double *HI = (double *) alloca(dims * sizeof(double));
    double *HII = (double *) alloca(dims * sizeof(double));
    double *HM  = (double *) alloca(dims * sizeof(double));
    double *HeI = (double *) alloca(dims * sizeof(double));
    double *HeII = (double *) alloca(dims * sizeof(double));
    double *HeIII = (double *) alloca(dims * sizeof(double));
    double *de = (double *) alloca(dims * sizeof(double));
    double *ge = (double *) alloca(dims * sizeof(double));

    field_data->H2I_density = H2I;
    field_data->H2II_density = H2II;
    field_data->HI_density = HI;
    field_data->HII_density = HII;
    field_data->HM_density = HM;
    field_data->HeI_density = HeI;
    field_data->HeII_density = HeII;
    field_data->HeIII_density = HeIII;
...
{   
    ...
    double *input = (double *) alloca(dims * N * sizeof(double));
    double *atol  = (double *) alloca(dims * N * sizeof(double));
    double *rtol  = (double *) alloca(dims * N * sizeof(double));
