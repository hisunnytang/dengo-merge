...
int cvode_solver( void *cvode_mem, double *output, int NEQ, double *dt, eq_H2_2_data * data, N_Vector y){
...
void *setup_cvode_solver( rhs_f f, jac_f Jac, double abstol, int NEQ, 
        eq_H2_2_data *data, SUNLinearSolver LS, SUNMatrix A, N_Vector y){
