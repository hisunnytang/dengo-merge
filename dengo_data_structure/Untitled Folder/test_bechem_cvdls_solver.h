...
typedef struct test_bechem_cvdls_data_ {
...
} test_bechem_cvdls_data;

test_bechem_cvdls_data *test_bechem_cvdls_setup_data(int *, char***);
...
void test_bechem_cvdls_read_gamma(test_bechem_cvdls_data*);
void test_bechem_cvdls_interpolate_gamma(test_bechem_cvdls_data*, int );
