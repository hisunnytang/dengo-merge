...
typedef struct omp_test_cvdls_data {
    ...
    // 2nd index is the number of threads 
    double scale[10][10];
    double inv_scale[10][10];
} omp_test_cvdls_data;

omp_test_cvdls_data *omp_test_cvdls_setup_data(int *, char***);
...
void omp_test_cvdls_interpolate_gamma(omp_test_cvdls_data*, int );
...
int calculate_jacobian_omp_test_cvdls( realtype t,
