...
def solver_performance(Tdim = 20 ,Ddim = 20 , solver_name = "grackle", safety_factor=1e-3):
    ...
    data_grackle, run_time = run_grackle(density = 1e10, initial_temperature = 1e3, final_time = 1e5, safety_factor=1e-2)
    data_dict = {}
    ...
    for temp, den in den_temp_pair2d:
        ...
        data_grackle, run_time = run_grackle(density = den, initial_temperature = temp, final_time = total_t, safety_factor=safety_factor)
...
# initialize data dictionary
solver_name = 'grackle'
time_taken, temp_arr, den_arr, filename = solver_performance(Tdim = 20 , Ddim = 20 , solver_name = solver_name)
