...
typedef struct sundials_time_data_ {
...
sundials_time_data *sundials_time_setup_data(int *, char***);
...
int cvodes_main_solver( rhs_f f, jac_f jac, 
                 ...
                 int nchem, void *sdata, double t0, double t1, int n_iter, double *T_arr, double *dt_arr, double *ttot_arr, double *success_arr);
