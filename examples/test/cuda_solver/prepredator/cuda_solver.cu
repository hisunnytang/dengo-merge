...
//NEED TO WORK HERE
// modify the f function and kerenel
// create a benchmark to compare with/without the cudasparse solver
...
int calculate_rhs_predator_prey(realtype t, N_Vector y, N_Vector ydot, void *user_data)
{
    ...
    // ideally, we should calculate temperature!
    // temperature_kerenl
    // and then interpolate rates here!
    // interpolate_Rates_kernel
