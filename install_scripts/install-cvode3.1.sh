...
cmake -DCMAKE_INSTALL_PREFIX=$cvode_inst -DKLU_INCLUDE_DIR="${suitesparse_inst}/include" -DKLU_LIBRARY_DIR="${suitesparse_inst}/KLU/lib" -DCMAKE_C_FLAGS=-fPIC -DKLU_ENABLE=ON ../
make && make install
